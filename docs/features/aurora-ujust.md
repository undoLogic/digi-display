...
```text
https://www.digi-display.com/en/Pages/demoSlideshow
```
...
- `url` defaults to `https://www.digi-display.com/en/Pages/demoSlideshow`
...
- Display URL, defaulting to `https://www.digi-display.com/en/Pages/demoSlideshow`
...
- The default URL is `https://www.digi-display.com/en/Pages/demoSlideshow` when no customer URL is entered
...
- The starter URL is `https://www.digi-display.com/en/Pages/demoSlideshow`
